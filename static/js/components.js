...
function currentID (){
    ...
    if (href === "https://note-app-tern.herokuapp.com/lists" || href === "https://note-app-tern.herokuapp.com/notes") {
        let id = Date.now();
        return id;
    } else {
        let id = targetID;
...
function ifCancel() {
    ...
    confirmExitBtn.addEventListener('click', function () {
        if (typeOfCard === "list") {
            if (window.location.href === "https://note-app-tern.herokuapp.com/lists") {
                goToHomePage();
            } else {
        ...
        if(typeOfCard === "note") {
            if (window.location.href === "https://note-app-tern.herokuapp.com/notes") {
                goToHomePage();
            } else {
